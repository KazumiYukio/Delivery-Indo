...
@if(isset(Auth::user()->username))
  ...
  <header class="main-header">
    ...
    <a href="#" class="logo">
      ...
      <span class="logo-mini">D<b>ID</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg">Delivery<b>ID</b></span>
    </a>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="{{ asset('img/logo_w.png')}}" class="img-circle" alt="User Image">
        </div>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        @yield('barang')<a href="{{ url('paketID') }}"><i class="fa fa-link"></i> <span>Data Barang</span></a></li>
        @yield('daftar')<a href="{{ url('paketID/daftar_kirim') }}"><i class="fa fa-link"></i> <span>Daftar Kirim</span></a></li>
        <!--other -->
        <li class="header">Other</li>
        <li><a href="{{ url('/paketID/logout') }}"><i class="fa fa-link"></i> <span>Logout</span></a></li>
      </ul>
      <!-- /.sidebar-menu -->
    </section>
    <!-- /.sidebar -->
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2021 <a href="#">DeliveryID</a>.</strong> All rights reserved.
  </footer>
